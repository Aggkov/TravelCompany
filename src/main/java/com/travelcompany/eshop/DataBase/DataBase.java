...
public class DataBase {
    ...
    private DataBase() {
        ...
        Itinerary itinerary6 = new Itinerary(6L, DepartureAirportCode.ATH, DestinationAirportCode.PAR, LocalDateTime.of(2022,02,22, 14, 55), Airline.SKYLINE, new BigDecimal("380"));
        Itinerary itinerary7 = new Itinerary(7L, DepartureAirportCode.ATH, DestinationAirportCode.PAR, LocalDateTime.of(2022,02,22, 15, 35), Airline.SKYLINE, new BigDecimal("350"));
        Itinerary itinerary8 = new Itinerary(8L, DepartureAirportCode.ATH, DestinationAirportCode.PAR, LocalDateTime.of(2022,02,22, 16, 00), Airline.SKYLINE, new BigDecimal("1020"));
        Itinerary itinerary9 = new Itinerary(9L, DepartureAirportCode.ATH, DestinationAirportCode.PAR, LocalDateTime.of(2022,02,22, 16, 35), Airline.SKYLINE, new BigDecimal("770"));
        ...
        Order order3 = new Order(3L, passenger3,itinerary3, PaymentMethod.CASH, new BigDecimal("224"));
        Order order4 = new Order(4L, passenger2,itinerary4, PaymentMethod.CASH, new BigDecimal("341"));
        Order order5 = new Order(5L, passenger3,itinerary4, PaymentMethod.CASH, new BigDecimal("248"));
        Order order6 = new Order(6L, passenger4,itinerary7, PaymentMethod.CASH, new BigDecimal("968"));
        Order order7 = new Order(7L, passenger5,itinerary7, PaymentMethod.CASH, new BigDecimal("968"));
